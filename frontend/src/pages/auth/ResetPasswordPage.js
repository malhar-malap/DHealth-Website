  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-800 px-4">
        <div className="max-w-md w-full bg-gray-900 p-10 rounded-2xl shadow-2xl border border-gray-800 text-center animate-fadeIn">
          <div className="mx-auto flex items-center justify-center h-20 w-20 rounded-full bg-green-100 mb-6">
            <FiCheckCircle className="h-12 w-12 text-green-600" />
          </div>
          <h2 className="text-3xl font-extrabold text-gray-100 mb-2">Success!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold text-gray-100">Set new password</h2>
          <p className="mt-2 text-sm text-gray-400">
            Resetting password for <span className="font-bold text-gray-100">{email}</span>
          </p>
        </div>
