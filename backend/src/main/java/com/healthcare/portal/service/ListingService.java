...
public class ListingService {
    ...
    public void approveListing(Long id, String uniqueCode, java.util.List<String> imageUrls) {
        ...
        if(uniqueCode != null && !uniqueCode.trim().isEmpty()) {
            listing.setUniqueCode(uniqueCode);
        }
    ...
    private void saveOrUpdateCategoryDetails(Listing listing, ListingDTO.ListingRequest request) {
        ...
        switch (categoryName) {
            ...
            case "dental centres":
                ...
                hospitalDetail.setAnnualRevenue(request.getAnnualRevenue());
                ...
                hospitalDetail.setStakePercentage(request.getStakePercentage());
            ...
            case "pharma companies":
                ...
                pharmaDetail.setEbitda(request.getEbitda());
                pharmaDetail.setTotalLandAreaSqft(request.getTotalLandAreaSqft());
            ...
            case "pharmacy":
            case "pharmacies":
                PharmacyDetail pharmacyDetail = pharmacyDetailRepository.findByListingId(listing.getId())
                        .orElseGet(PharmacyDetail::new);
                pharmacyDetail.setListing(listing);
                pharmacyDetail.setPremisesType(request.getPremisesType());
                pharmacyDetail.setYearsInBusiness(request.getYearsInBusiness());
                pharmacyDetail.setIsFurnished(request.getIsFurnished());
                pharmacyDetail.setCarpetAreaSqft(request.getCarpetAreaSqft());
                pharmacyDetail.setOneLineDescription(request.getOneLineDescription());
                pharmacyDetailRepository.save(pharmacyDetail);
                break;
    ...
    private ListingDTO.ListingSummaryResponse mapToSummaryResponse(Listing listing) {
        ...
        response.setUniqueCode(listing.getUniqueCode());
        ...
        switch (categoryName) {
            ...
            case "pharmacy":
            case "pharmacies":
                pharmacyDetailRepository.findByListingId(listing.getId())
                        .ifPresent(response::setCategoryDetails);
                break;
            case "medical equipment":
