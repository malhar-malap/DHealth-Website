...
public class Listing {
    ...
    @Column(name = "unique_code", length = 50, unique = true)
    ...
    @OneToOne(mappedBy = "listing", cascade = CascadeType.ALL, orphanRemoval = true)
    private PharmacyDetail pharmacyDetail;
    ...
    public PharmacyDetail getPharmacyDetail() { return pharmacyDetail; }
    public void setPharmacyDetail(PharmacyDetail pharmacyDetail) { this.pharmacyDetail = pharmacyDetail; }
