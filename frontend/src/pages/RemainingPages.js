        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
          ...
          <div className="flex flex-wrap items-center gap-4 w-full md:w-auto">
            <select
              ...
              className="bg-gray-900 border border-ethereal-outline-variant px-4 py-2.5 rounded-full text-sm focus:ring-2 focus:ring-ethereal-primary/20 focus:outline-none transition-all"
            >
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-6">
                          ...
                          {app.cvUrl && (
                            <a 
                              href={`http://dhacquisitions.co:8080${app.cvUrl.replace('/api/listings/media/', '/api/uploads/')}`} 
                              target="_blank" 
                      ...
                      {activeTab === 'received' && app.status === 'APPLIED' && (
                        <div className="flex lg:flex-col items-stretch gap-3 lg:w-48 lg:border-l border-ethereal-outline-variant/30 lg:pl-8 pt-8 lg:pt-0">
                          <button 
                            ...
                            className="flex-1 bg-ethereal-secondary text-white py-3 rounded-2xl font-bold shadow-lg shadow-[#d8572a]/10 hover:shadow-[#d8572a]/20 hover:scale-[1.02] transition-all"
                          >
                            Shortlist
                          </button>
                          <button 
